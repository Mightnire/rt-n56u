...
- 修正 MI-R3P-spi 内核配置：NAND→SPI 闪存、ETH_LEDS、移除无效 STORE_PART_SIZ
- 修复 MI-R3P-spi SPI 闪存 MTD_STORE_PART_SIZ 缺失导致编译报错
- 确认 BW050-A 5G FEM SKY85703-11 需使用 eeprom(1).bin 校准数据
